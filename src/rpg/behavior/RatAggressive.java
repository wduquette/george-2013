...
/** This class implements standard aggressive behavior for lower animals.  
 * The mobile might be sleeping or wandering; if it notices an enemy, it will 
 * chase it and attack unless the enemy is too far off.  It only responds
 * to enemies it can see, and it chases naively.<p>
 * 
 ...
 * 
 * <li>If he is chasing and no visible enemy is within the chase range, he 
 ...
 * <li>If he is chasing he closes with the closest visible enemy and attacks
 *     if possible.
 * </ul><p>
 *
 * @author will
 */
public class RatAggressive implements Behavior, Serializable {
